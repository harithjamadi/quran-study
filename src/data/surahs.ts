...
// Factual reference data for the 114 chapters of the Quran. Names and ayah counts
// are universal constants used by every Quran resource.
export const SURAHS: SurahMeta[] = [
  ...
  { number: 33, name: "الأحزاب", englishName: "Al-Ahzaab", englishNameTranslation: "The Confederates", numberOfAyahs: 73, revelationType: "Medinan" },
  ...
  { number: 55, name: "الرحمن", englishName: "Ar-Rahmaan", englishNameTranslation: "The Most Merciful", numberOfAyahs: 78, revelationType: "Medinan" },
...
export const SURAH_MS_TRANSLATIONS: Record<number, string> = {
  ...
  41: "Dijelaskan Secara Terperinci",
  42: "Perundingan",
  43: "Perhiasan Emas",
  44: "Asap",
  45: "Yang Berlutut",
